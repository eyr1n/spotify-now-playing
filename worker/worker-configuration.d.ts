/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: cf19b9d6bf98a88f1e0b532aa75860a6)
// Runtime types generated with workerd@1.20260430.1 2026-05-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "SpotifyToken";
	}
	interface Env {
		CLIENT_ID: string;
		CLIENT_SECRET: string;
		REFRESH_TOKEN: string;
		SPOTIFY_TOKEN: DurableObjectNamespace<import("./index").SpotifyToken>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLIENT_ID" | "CLIENT_SECRET" | "REFRESH_TOKEN">> {}
}
